...
| Segment | Exposure | What is happening |
|---|---|---|
| Telephony and IVR | Very high | Effectively conceded. Systems are generated and updated in software, and the cost of a re-record is now zero |
| High-volume e-learning and compliance modules | High | Bulk scripts, frequent revision, no named performer. The economics favour synthesis and the buyer rarely resists |
| Low-budget corporate and explainer video | High | The commodity end of the market, where price is the only criterion |
| Radio imaging, promos, station fill | High and rising | Being taken in-house as much as by AI; a US television group cut voice talent across more than 260 stations |
| Bulk localisation and dubbing | Very high | The hardest-hit segment worldwide, and the one with the fewest protections |
| Self-published non-fiction audiobooks | High | Audible's Virtual Voice took the long tail almost entirely |
| Branded and character audiobook work | Low | Buyers pay for performance, and listeners are moving away from AI narration, not towards it |
| Regulated medical and pharmaceutical narration | Low | Approval chains, liability and pronunciation risk make a briefable human cheaper than an error |
...
The industry's favourite argument is that listeners can always tell. They cannot, and it is worth Monica knowing this before a client tells her.
...
Three jurisdictions are moving at three speeds.

The European Union is furthest ahead. Article 50 of the AI Act requires providers of systems generating synthetic audio to mark that output in a machine-readable form, and requires deployers to disclose synthetic content to a person at first exposure, in a way perceivable without special tools. Those obligations apply from 2 August 2026, with a transition to 2 December 2026 for systems already on the market before that date.

The United States protects performers mainly through contract. SAG-AFTRA's 2025 Interactive Media Agreement sets bargained minimums for digital replicas, pays vocal replica work by generated line of roughly ten words, and lets performers withdraw consent for new generation during a strike. The commercials contracts require consent for every use of a digital voice replica and let performers set their own price above the minimum. Federal statute is still pending: the NO FAKES Act and the NO AI FRAUD Act are before Congress, and several states have acted on their own.

The United Kingdom has the weakest position of the three. There is no standalone right in a person's voice. A claimant has to assemble a case from passing off, defamation, data protection and copyright, none of which was designed for this. On 28 August 2026 more than eighty performers wrote to the Prime Minister asking for a statutory right over the use of a person's voice, held by everyone rather than only by working performers. The signatories included Matt Lucas, Hugh Bonneville, Nicola Coughlan, Siobhán McSweeney and Luke Evans, and the campaign behind the letter, Save Our Voices Now, was co-founded by the audiobook narrator Alice Sockett and the performer Peter Caulfield. The government has so far offered a consultation rather than legislation. Equity held an indicative ballot in late 2025 in which 99.6 per cent of those responding said they would refuse digital scanning without contractual protection, and the union has pursued claims for more than twenty members whose voices were allegedly used without permission.

The practical consequence for Monica is plain. Until Parliament acts, her contract is her protection, and nothing else is. Every engagement she takes should say in writing whether the recording may be used to train or generate a synthetic voice, and the default answer should be no unless she is paid separately for it.

## Medical work, considered on its own

Monica has named medical advertising and demos for organisations as her main target. That is a better-defended position than most, for structural reasons rather than sentimental ones.
...
The trap is irreversibility. Once a model of a voice exists, audio already generated from it cannot be recalled, and a licence with loose scope or no end date cannot be walked back by regret. If Monica licenses, she should license narrow: named uses, a stated term, a right to withdraw future generation, and an explicit exclusion of political, adult, medical-claim and endorsement content. If she does not want to license at all, the site should say so, because that itself is a selling point to buyers who care about provenance.
...
1. Enter above the floor. Do not price against synthesis on the commodity end, because that fight is lost and winning it pays badly. Price and pitch against the work where a human is the point.
2. Make the specialism the whole proposition. Medical narration with acting training, correct clinical pronunciation and a Hindi second language is a defensible position. "Voiceover artist available for all projects" is not.
...
- [NAVA State of Voiceover Survey 2026](https://navavoices.org/vo-survey-2026/), National Association of Voice Actors, fielded 22 January to 22 February 2026, 1,379 responses; analysis at [Dane Reid Media](https://danereidmedia.com/2026/03/31/what-the-2026-voiceover-survey-reveals-about-our-industry/) and [Enterprise DNA](https://enterprisedna.co/resources/news/nava-voice-actors-washington-ai-creative-economy-2026/)
- [Audio Publishers Association consumer survey](https://www.publishersweekly.com/pw/by-topic/digital/content-and-e-books/article/100825-some-favor-ai-narration-for-multi-cast-audiobooks-even-as-interest-in-ai-voices-wanes.html), Edison Research at SSRS, 1,005 US fiction audiobook listeners, released 5 June 2026
...
- [Article 50, EU AI Act](https://artificialintelligenceact.eu/article/50/), transparency obligations applying from 2 August 2026
- [SAG-AFTRA Interactive Media Agreement](https://www.sagaftra.org/sag-aftra-national-board-approves-interactive-media-agreement) and the union's [AI resources](https://www.sagaftra.org/contracts-industry-resources/member-resources/artificial-intelligence)
- [Save Our Voices Now campaign letter](https://www.itv.com/news/2026-08-28/nicola-coughlan-and-matt-lucas-among-stars-backing-ai-voice-cloning-campaign), ITV News, 28 August 2026, and [Variety](https://variety.com/2026/digital/global/nicola-coughlan-matt-lucas-ai-voice-cloning-law-1236845817/)
- [Voices have value; the law just hasn't caught up](https://www.glaisyers.com/voices-have-value-the-law-just-hasnt-caught-up/), Glaisyers ETL, on the UK position
...
- [FDA AI drug advertising enforcement and pharma compliance](https://intuitionlabs.ai/articles/fda-ai-drug-advertising-enforcement-compliance)

Segments and platforms:

- [Now in Beta: Narrator Voice Replicas on ACX](https://www.acx.com/mp/blog/now-in-beta-narrator-voice-replicas-on-acx)
- [Voice Actor Payouts](https://elevenlabs.io/docs/help-center/product/monetization-business/payouts/what-are-voice-actor-payouts), ElevenLabs
- [Voice actors fight to save their livelihoods and local cultures from Hollywood's AI push](https://restofworld.org/2026/ai-voice-actors-hollywood-dubbing/), Rest of World, 2026
- [How AI Is Threatening India's Voice Artists and Dubbing Industry](https://www.hollywoodreporter.com/movies/movie-news/ai-is-replacing-voice-artists-in-india-1236335714/), The Hollywood Reporter
- [Why Voiceover Artists Aren't Totally Threatened By the Rise of AI](https://barrettmedia.com/2026/08/14/voiceover-artists-threatened-by-ai/), Barrett Media, 14 August 2026
- [Entry level jobs for aspiring voice actors drying up as use of AI spreads](https://www.swlondoner.co.uk/news/03072026-listen-entry-level-jobs-for-aspiring-voice-actors-drying-up-as-use-of-ai-spreads), SW Londoner, 3 July 2026
- [2026 predictions for healthcare and pharmaceutical marketing](https://www.spectrumscience.com/perspectives/2026-pharma-marketing-predictions/), Spectrum Science, on the shift away from scripted voiceover
- [Certified Human Voice](https://www.academyvoices.com/certifiedhumanvoice) and [Verified Human](https://verifiedhumancert.com/), human-performance certification marks
