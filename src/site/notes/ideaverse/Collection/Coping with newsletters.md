---
{"dg-publish":true,"permalink":"/ideaverse/collection/coping-with-newsletters/","dg-note-properties":{"description":"Diary entry of 22 June 2025 on filtering newsletters with NotebookLM and what it surfaced about AI regulation","created":"2026-08-31","posted":"2025-06-22","categories":["[[ideaverse/Collection/Notebook diary]]","[[ideaverse/Collection/Anapoly Notebook]]"],"provenance":"alec"}}
---
...
*<--- [[ideaverse/Collection/How we flag AI involvement in what we publish\|How we flag AI involvement in what we publish]]*
*---> [[ideaverse/Collection/Sandboxes\|Sandboxes]]*
...
When I used that prompt, one of the points it picked up was that our [transparency framework](https://anapoly.co.uk/labs/transparency-framework/) ties in well to the [EU AI Act](https://www.europarl.europa.eu/topics/en/article/20230601STO93804/eu-ai-act-first-regulation-on-artificial-intelligence), which has a section on transparency requirements That prompted me to look into the UK’s approach. I learned that, instead of regulations, we have [regulatory principles](https://assets.publishing.service.gov.uk/media/65c0b6bd63a23d0013c821a0/implementing_the_uk_ai_regulatory_principles_guidance_for_regulators.pdf) for the guidance of existing regulatory bodies such as the Information Commissioner’s Office or Ofcom. The principles cover:
