---
{"dg-publish":true,"permalink":"/ideaverse/collection/use-cases-for-notebook-lm/","dg-note-properties":{"description":"Diary entry of 25 June 2025 on Steven Johnson's use cases for NotebookLM in historical research","created":"2026-08-31","posted":"2025-06-25","categories":["[[ideaverse/Collection/Notebook diary]]","[[ideaverse/Collection/Anapoly Notebook]]"],"provenance":"alec"}}
---
...
*Written by Alec Fearon on 25 June 2025 in Anapoly Diary*
*Transparency label: Human-only*
*<--- [[ideaverse/Collection/How ChatGPT helped draft our first acclimatisation lab setup\|How ChatGPT helped draft our first acclimatisation lab setup]]*
*---> [[ideaverse/Collection/First thoughts on a lab framework\|First thoughts on a lab framework]]*

---

[Posting in his SubStack](https://open.substack.com/pub/adjacentpossible/p/machine-readable?utm_campaign=post&utm_medium=web) Adjacent Possible, Steven Johnson discusses how “ *language models are opening new avenues for inquiry in historical research and writing* “. He suggests they can act as collaborative tools, rather than replacements for the writer’s engagement with primary sources.
