...
Building on recent work around the [three-layer model of AI context](https://www.anapoly.co.uk/files/the-three-layer-model-of-ai-context.pdf), I spent some time today working with ChatGPT to write a full [[ideaverse/Collection/Anapoly three-layer instruction set\|three-Layer Instruction]] set for use in Anapoly’s ChatGPT Projects.
